...
import com.simple.wildfishingnote.utils.SpinnerHelper;
...
public class AddPointActivity extends ActionBarActivity implements RodLengthDialogFragment.NoticeDialogListener,
    ...
    private void initRodLengthSpinner() {
        ...
        RodLength[] arr = list.toArray(new RodLength[list.size()]);

        SpinnerHelper.initSpinner(arr, this, R.id.addPointRodLengthSpinner);
    }

    private void setRodLengthSpinnerSelection(String selectedId) {
        List<RodLength> list = dataSource.getAllRodLengths();

        int selectedIndex = SpinnerHelper.getSelectedIndex(selectedId, list);
    ...
    private void initLureMethodSpinner() {
        ...
        LureMethod[] arr = list.toArray(new LureMethod[list.size()]);

        SpinnerHelper.initSpinner(arr, this, R.id.addPointLureMethodSpinner);
    }
    ...
    private void initBaitSpinner() {
        ...
        Bait[] arr = list.toArray(new Bait[list.size()]);

        SpinnerHelper.initSpinner(arr, this, R.id.addPointBaitSpinner);
    }
